...
namespace idr200Svr1
{
    class WebSocket
    {
        ...
        public void start(int port)
        {
            ...
            IdrLog.write(IdrLog.Info, string.Format("WebService is started,service port:{0:d}",port));
        ...
        private void Accept(IAsyncResult socket)
        {
            ...
            try
            {
                ...
                IdrLog.write(IdrLog.Info, string.Format("Client {0} connected", session.IP));
            }
            catch (Exception ex)
            {
                IdrLog.write(IdrLog.Error, "Error : " + ex.ToString());
            }
        }
        #endregion
        ...
        private void Recieve(IAsyncResult socket)
        {
            ...
            try
            {
                ...
                IdrLog.write(IdrLog.Info, string.Format("receive {0}:{1}", IP, msg));
            ...
            catch
            {
                ...
                IdrLog.write(IdrLog.Info, string.Format("Client {0} connection closed.", IP));
        ...
        private byte[] PackageHandShakeData(byte[] handShakeBytes, int length)
        {
            ...
            string msg1 = responseBuilder.ToString();
            
            return Encoding.UTF8.GetBytes(msg1);
        }
        #endregion
